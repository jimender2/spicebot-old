...
def autoblock(bot):
    for channel in bot.channels:
        bot.msg(channel, 'channel is ' + str(channel))
        ...
        if not fingertime:
            ...
            bot.msg(channel, 'finger bigger, resetting time, and user counts')
            ...
            for u in channel:
                userstotal = bot.db.get_nick_value(target, 'spicebot_usertotal') or 0
