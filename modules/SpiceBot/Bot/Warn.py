...
def mainfunction(bot, trigger):
    ...
    if rand < 5:
        osd(bot, inchannel, 'say', target + "This is just a warning. Overuse of the bot can get you kicked or banned by an operator. If you want to purely play with the bot, go to #Spicebot or #Spicebottest, or send Spicebot a PrivateMessage.")
    else:
