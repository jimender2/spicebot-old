...
@sopel.module.commands('testquote')
def mainfunction(bot, trigger):
    enablestatus, triggerargsarray = spicebot_prerun(bot, trigger, 'testquote')
    if not enablestatus:
...
def getsaying(bot, trigger, triggerargsarray, databasekey): 
