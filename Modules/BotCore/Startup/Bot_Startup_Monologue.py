...
def bot_startup_monologue(bot, trigger):
    ...
    while not bot_startup_requirements_met(bot, ["botdict", "uptime", "bot_info", "ext_conf", "server", "channels", "users", "txt_files", "auth_reddit", "ip_address", "auth_twitter", "auth_googlecal", "cache"]):
        pass
