...
def bot_startup_botinf(bot, trigger):
    ...
    # Read configuration
    bot.memory["botdict"]["tempvals"][str(bot.nick)]["bot_info"]['configuration'] = config_file_to_dict(bot, str(bot.memory["botdict"]["tempvals"]["bot_info"][str(bot.nick)]['config_file']))
